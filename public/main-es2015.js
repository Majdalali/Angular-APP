...
/* harmony import */ var countup_js_angular2__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! countup.js-angular2 */ "./node_modules/countup.js-angular2/fesm2015/countup.js-angular2.js");
...
let HomeComponent = class HomeComponent {
    constructor(validateServices, Flashmsg, authservices, router) {
...
let LoginComponent = class LoginComponent {
    constructor(Flashmsg, authservices, router) {
        this.Flashmsg = Flashmsg;
        this.authservices = authservices;
        this.router = router;
    }
...
let AuthGuard = class AuthGuard {
    constructor(authservices, router) {
        this.authservices = authservices;
        this.router = router;
    }
    canActivate() {
